...
`main.tex` sets `\graphicspath` to the two directories above, so figures are
...
| `verification_lte_limit.pdf` | §4.1, steady + convergence | `verification_lte_limit.py` |
